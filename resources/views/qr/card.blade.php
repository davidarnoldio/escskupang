...
<body class="bg-slate-100 flex flex-col items-center justify-center min-h-screen p-4 font-sans text-slate-800">
    ...
    <div class="no-print mb-6 flex gap-3">
        ...
        <button onclick="window.print()" class="px-5 py-2 bg-slate-900 hover:bg-slate-800 text-emerald-400 font-bold rounded-xl text-sm shadow-md transition cursor-pointer flex items-center gap-2">
    ...
    <div class="w-[360px] bg-white rounded-2xl shadow-2xl border border-emerald-500/20 overflow-hidden relative">
        <!-- Header Gradient -->
        <div class="bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-4 text-white text-center relative overflow-hidden border-b border-emerald-500/30 flex items-center justify-center gap-3">
            <img src="{{ asset('images/logo.png') }}" alt="Logo NTO" class="h-12 w-auto object-contain">
            <div class="text-left">
                <p class="text-[9px] font-extrabold uppercase tracking-widest text-emerald-400">KARTU TANDA PELAJAR</p>
        ...
        <div class="p-6 text-center space-y-4">
            ...
            <div class="relative inline-block">
                <div class="w-20 h-20 rounded-2xl bg-slate-900 text-emerald-300 border-2 border-emerald-400/40 flex items-center justify-center font-extrabold text-2xl shadow-md mx-auto">
            ...
            <div>
                ...
                <p class="text-xs font-mono text-emerald-600 font-bold mt-0.5">NIS: {{ $student->nis }}</p>
