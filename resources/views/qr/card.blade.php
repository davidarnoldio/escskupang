...
<body class="bg-slate-100 flex flex-col items-center justify-center min-h-screen p-4 font-sans text-slate-800">
    ...
    <div class="no-print mb-6 flex gap-3">
        ...
        <button onclick="window.print()" class="px-5 py-2 bg-slate-900 hover:bg-slate-800 text-sky-400 font-bold rounded-xl text-sm shadow-md transition cursor-pointer flex items-center gap-2">
    ...
    <div class="w-[360px] bg-white rounded-2xl shadow-2xl border border-sky-500/20 overflow-hidden relative">
        ...
        <div class="p-6 text-center space-y-4">
            ...
            <div class="relative inline-block">
                <div class="w-20 h-20 rounded-2xl bg-slate-900 text-sky-300 border-2 border-sky-400/40 flex items-center justify-center font-extrabold text-2xl shadow-md mx-auto">
            ...
            <div>
                ...
                <p class="text-xs font-mono text-sky-600 font-bold mt-0.5">NIS: {{ $student->nis }}</p>
