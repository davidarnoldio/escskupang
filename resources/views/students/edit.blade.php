            ...
            <div class="bg-white rounded-2xl shadow-xs border border-slate-200/80 p-6 sm:p-8">
                <form method="POST" action="{{ route('students.update', $student) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nis" name="nis" value="{{ old('nis', $student->nis) }}" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:bg-white transition">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $student->nama) }}" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:bg-white transition">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-6 pt-2">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', $student->jenis_kelamin) == 'L' ? 'checked' : '' }} class="w-4 h-4 text-sky-600 border-slate-300 focus:ring-sky-500">
                                    <span class="ms-2 text-sm text-slate-700 font-semibold">Laki-laki (L)</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin', $student->jenis_kelamin) == 'P' ? 'checked' : '' }} class="w-4 h-4 text-sky-600 border-slate-300 focus:ring-sky-500">
                    ...
                    <div class="p-4 bg-indigo-50/60 border border-indigo-200/80 rounded-2xl">
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_abk" value="0" {{ old('is_abk', $student->is_abk ? '1' : '0') == '0' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500">
                                <span class="ms-2 text-sm text-slate-800 font-semibold">Siswa Regular (Umum)</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_abk" value="1" {{ old('is_abk', $student->is_abk ? '1' : '0') == '1' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="telepon" name="telepon" value="{{ old('telepon', $student->telepon) }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:bg-white transition">
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" rows="3" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:bg-white transition">{{ old('alamat', $student->alamat) }}</textarea>
