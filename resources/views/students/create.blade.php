            ...
            <div class="bg-white rounded-2xl shadow-xs border border-slate-200/80 p-6 sm:p-8">
                <form method="POST" action="{{ route('students.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nis" name="nis" value="{{ old('nis') }}" required placeholder="Contoh: 10201" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500 focus:bg-white transition">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required placeholder="Contoh: Ahmad Subagja" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500 focus:bg-white transition">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-class-combobox name="kelas" id="kelas" :value="old('kelas')" :officialClasses="\App\Models\Student::getAllClasses()" :required="true" />
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-6 pt-2">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', 'L') == 'L' ? 'checked' : '' }} class="w-4 h-4 text-red-600 border-slate-300 focus:ring-red-500">
                                    <span class="ms-2 text-sm text-slate-700 font-semibold">Laki-laki (L)</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }} class="w-4 h-4 text-red-600 border-slate-300 focus:ring-red-500">
                    ...
                    <div class="p-4 bg-red-50/60 border border-red-200/80 rounded-2xl">
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_abk" value="1" {{ old('is_abk') == '1' ? 'checked' : '' }} class="w-4 h-4 text-red-600 border-slate-300 focus:ring-red-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="telepon" name="telepon" value="{{ old('telepon') }}" placeholder="Contoh: 081234567890" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500 focus:bg-white transition">
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap siswa..." class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500 focus:bg-white transition">{{ old('alamat') }}</textarea>
