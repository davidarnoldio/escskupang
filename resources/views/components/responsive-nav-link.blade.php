...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-sky-400 text-start text-base font-bold text-sky-400 bg-slate-800/80 focus:outline-none transition duration-150 ease-in-out'
