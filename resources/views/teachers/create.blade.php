            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100">
                <form method="POST" action="{{ route('teachers.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required placeholder="nama.guru@nto-kupang.sch.id" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
                    ...
                    <div x-data="{ showPassword: false }">
                        ...
                        <div class="relative">
                            <input id="password" :type="showPassword ? 'text' : 'password'" name="password" required placeholder="Minimal 6 karakter..." class="w-full px-4 py-2.5 pe-11 bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500">
