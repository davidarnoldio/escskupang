<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="text-xs font-semibold text-red-600 mt-1">NTO National Plus Primary School</p>
    </div>

    <div class="mb-5 p-4 bg-red-50/80 border border-red-100 rounded-2xl text-xs text-red-900 leading-relaxed font-medium">
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="Masukkan alamat email Anda"
                       class="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 focus:bg-white transition duration-200">
            </div>
